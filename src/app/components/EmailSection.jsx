...
const EmailSection = () => {
  ...
  return (
    ...
    id="contact"
    className="relative my-12 py-24 flex justify-center items-center"
  >
    ...
    <div className="relative z-10 w-full max-w-md">
      {emailSubmitted ? (
        ...
        <form className="flex flex-col" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className=" bg-green-200  text-slate-800 font-medium py-2.5 px-5 rounded-lg w-full  hover:bg-orange-200"
          >
            Send Message
          </button>
        </form>
